...
services:
  ...
  db_backup:
    ...
    environment:
      ...
      POSTGRES_USER: ${POSTGRES_USER}
      POSTGRES_PASSWORD: ${POSTGRES_PASSWORD}
    entrypoint: ["sh", "-c", "while true; do PGPASSWORD='SuperDockerPassword5432!!!' ceci_aguilera_react_django_nginx_postgresql-database-1 pg_dump -U docker docker > '/backups/db_backup_$(date +%Y%m%d_%H%M%S).sql'; sleep 86400; done"]
