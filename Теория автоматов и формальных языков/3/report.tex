...
\begin{tabular}{|c|c|c|c|c|c|}
    ...
    \hline
    1 & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_3$, $N_4$,\\$N_5$, $N_6$\}\end{tabular} & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_3$, $N_4$,\\$N_5$, $N_6$,\\$N_7$\}\end{tabular} & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_3$, $N_4$,\\$N_5$, $N_6$\}\end{tabular} & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_3$, $N_4$,\\$N_5$, $N_6$,\\$N_7$\}\end{tabular} & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_3$, $N_4$,\\$N_5$, $N_6$,\\$N_7$\}\end{tabular} \\
    \hline
    0 & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_5$, $N_6$\}\end{tabular} &                \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_5$, $N_6$,\\$N_7$\}\end{tabular}                & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_5$, $N_6$\}\end{tabular}                & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_5$, $N_6$\}\end{tabular}                        & \begin{tabular}{c}\{$N_1$, $N_2$,\\$N_5$, $N_6$\}\end{tabular} \\
    \hline
\end{tabular}
