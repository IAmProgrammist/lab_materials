...
Process finished with exit code 0
  ...
  Последовательность правил 1 выполнима при левом выводе.\\
  Последовательность правил 2 невыполнима.\\
  Последовательность правил 3 выполнима при правом выводе.\\
  Последовательность правил 4 невыполнима.\\
